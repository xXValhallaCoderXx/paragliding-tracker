...
import { Button } from '@/components/flight-ui';
import { RECORDER_CONFIG } from '@/recorder/config';
import type { FlightDetail, TrackQuality } from '@/recorder/types';
import { formatBattery, formatGap, formatThousands, qualityLabel } from '@/ui/flight-format';
...
function gapSummary(quality: TrackQuality, maxGapMs: number | null): string {
  switch (quality) {
    case 'healthy':
      return 'no gaps';
    case 'gaps':
