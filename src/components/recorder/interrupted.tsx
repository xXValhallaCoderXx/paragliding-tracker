  ...
  return (
    <Screen>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Card variant="dark" style={styles.stats}>
...
const styles = StyleSheet.create({
  ...
  stats: { marginHorizontal: 16, paddingHorizontal: 16, paddingTop: 15, paddingBottom: 13 },
  ...
  partialButton: { borderColor: paper.attentionBorder },
